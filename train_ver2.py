...
def scene_reconstruction(dataset, opt, hyper, pipe, testing_iterations, saving_iterations,
    ...
    for iteration in range(first_iter, final_iter+1):
        ...
        #----------------------------------------------
        Ll1 = l1_loss(rendered_images, gt_images, mask)
        ...
        grad_weight = 0.001
        sm_loss = grad_loss(rendered_depths, gt_depths,) * grad_weight
        loss += sm_loss
        #-----------------------------------------------
        ...
        normal_weight = 0.001
        pseudo_normal = get_pseudo_normal(gt_depths, None)
        ...
        confidence_loss_dep = confidence_loss(gt_depths/gt_depths.max(),
                                                rendered_depths/rendered_depths.max(), confidences, None)*un_dep_weight
        ...
        psnr_ = psnr(rendered_images, gt_images, mask=None).mean().double()
